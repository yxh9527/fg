...
type SlotsDoBetReq struct {
	...
	AverageBet    float64                `protobuf:"fixed64,13,opt,name=averageBet,proto3" json:"averageBet,omitempty"` // 购买免费触发局才带值：整段免费按赠送次数折算的每转平均下注（元）；其余为 0
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SlotsDoBetReq) GetAverageBet() float64 {
	if x != nil {
		return x.AverageBet
	}
	return 0
...
func (x *SlotsDoBetFreeReq) GetAverageBet() float64 {
	if x != nil {
		return x.AverageBet
	}
	return 0
...
func (x *FruitDoBetReq) GetAverageBet() float64 {
	if x != nil {
		return x.AverageBet
	}
	return 0
...
const file_lottery_proto_rawDesc = "" +
	...
	"\x15deleteGameStorageKeys\x18\x02 \x03(\tR\x15deleteGameStorageKeys\"\xce\x03\n" +
	...
	"\vflowControl\x18\f \x01(\v2\x1d.lottery.SlotDoBetFlowControlR\vflowControl\x12\x1e\n" +
	"\n" +
	"averageBet\x18\r \x01(\x01R\n" +
	"averageBet\"\xd4\x03\n" +
